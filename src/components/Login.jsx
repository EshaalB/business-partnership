          ...
          <div class="grid md:grid-cols-2 items-center gap-10 max-w-6xl w-full">
            ...
            <form class="space-y-6 max-w-md md:ml-auto max-md:mx-auto w-full">
              ...
              <div class="flex items-center justify-between">
                ...
                <div class="text-sm">
                  <a
                    ...
                    class="text-darkBlue hover:text-darkBlue"
                  >
              ...
              <div class="!mt-10">
                <button
                  type="button"
                  class="w-full shadow-xl py-2.5 px-4 text-sm font-semibold rounded text-white bg-darkBlue hover:bg-blue-700 focus:outline-none"
                >
                  Log in
                </button>
              </div>
